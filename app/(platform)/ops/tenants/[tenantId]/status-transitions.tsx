          ...
          <div className="w-full max-w-md rounded-card bg-paper border border-line p-5">
            ...
            <label className="mt-4 block">
              ...
              <textarea
                ...
                className="mt-1 w-full rounded-ctl border border-line bg-paper px-3 py-2 text-[14px] text-ink placeholder:text-ink-3 focus:border-[var(--accent)] outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)]"
              />
