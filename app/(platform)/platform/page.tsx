...
// lifecycle, feature catalogue) are linked from here — this page
// exists to give a logged-in operator the obvious next move rather
// than a dead-end with content scattered elsewhere.
