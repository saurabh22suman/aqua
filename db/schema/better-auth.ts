...
export const baAccount = pgTable(
  ...
  (t) => [unique("ba_account_provider_account_key").on(t.providerId, t.accountId)],
);
...
export const betterAuthSchema = { user: baUser, session: baSession, account: baAccount, verification: baVerification };
