...
const ALLOWLIST = new Set([
  ...
  "tests/tier1/coach-me-page.test.ts", // F4 (mobile UX plan v2): real-DB coach membership drives CoachMePage, same fixture-setup pattern as batch-detail-page above
